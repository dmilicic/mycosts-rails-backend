...
class CostsControllerTest < ActionController::TestCase
  ...
  test "should create cost" do
    assert_difference('Cost.count') do
      post :create, cost: { amount: @cost.amount, category: @cost.category, currency: @cost.currency, date: @cost.date, description: @cost.description }
    end
  ...
  test "should update cost" do
    patch :update, id: @cost, cost: { amount: @cost.amount, category: @cost.category, currency: @cost.currency, date: @cost.date, description: @cost.description }
    assert_redirected_to cost_path(assigns(:cost))
  end
